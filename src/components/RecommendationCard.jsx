  ...
  return (
    <article className="recommendation-card card">
      <div className="card-topline">
        <span className="score-badge">지도 복원도 {score}%</span>
      ...
      <div className="reason-panel">
        <span>이 지점이 지금의 나와 이어지는 이유</span>
      ...
      <button className="primary-button full push-bottom" onClick={() => onSelect(hobby)}>이 지점부터 가보기</button>
    </article>
  );
}
